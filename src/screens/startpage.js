...
export default function StartPage () {
  return(
      <View className='h-full px-5 mt-12 pb-14'>
        <View className='py-5'>
          <Image style={{width:200, height:100, maxHeight:100, resizeMode:'contain'}}  source={require('../../assets/logo.png')} />
        </View>

        <View className='justify-center items-center'>
          <Image style={{width:320, height:200, resizeMode:'contain'}}  source={require('../../assets/ilustracao.png')} />
        </View>
